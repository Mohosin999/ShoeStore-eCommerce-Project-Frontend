...
const ProductList = () => {
  ...
  // Maximum pagination related - start
  ...
  //   }
  // };
  // Maximum pagination related - end
  ...
  return (
    <Wrapper>
      <div className="flex flex-wrap mt-28">
        {/* Left side */}
        <div className="w-1/3 bg-gray-600 p-10">
          <h1>Left Side</h1>
          ...
          {/* <div className="mt-4 flex justify-center items-center">
            ...
            {Array.from({ length: 3 }).map((_, index) => (
              <button
                ...
                onClick={() => handlePageChange(currentPage + index - 1)}
...
//                 }`}
//               >
//                 {/* Index started from 0, that's why index+1 (0+1) */}
//                 {index + 1}
//               </button>
//             ))}
